...
class _$ItemModelImpl implements _ItemModel {
  _$ItemModelImpl({required this.name, required this.path});
  ...
  @override
  String toString() {
    return 'ItemModel(name: $name, path: $path)';
  }
...
abstract class _ItemModel implements ItemModel {
  factory _ItemModel({required final String name, required final String path}) =
      _$ItemModelImpl;
